  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content font-smaller">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="editProfileLabel">Cari Skripsi</h1>
        ...
        $("#addmore").click(function() {
            $("#examiner-list-head").append(`
                <li class="examiner-list">
                    ...
                    <input type="button" class="inputRemove btn btn-sm btn-outline-danger w-100 mb-3" value="Remove"/>
                </li>
            `);
        });
